...
const Drawer = ({ open, onToggle }) => {
  ...
  useEffect(() => {
    const offline = async () => {
      await axios.post(`${url}/users/online-users`, {}, config).catch(() => {});
    };
    if (logout) {
      offline();
      localStorage.clear();
          ...
          <Box hidden={!open} sx={{ textAlign: "center" }}>
            ...
            <div className="mt-2 flex gap-5 mx-auto text-center justify-center text-sm">
              <div className="text-blue-500">
                <a href="/files/Credore-Privacy-Policy.pdf" target="_blank">
                  Privacy Policy
                </a>
              </div>
              |
              <div className="text-blue-500">
                <a href="/files/Credore-Terms-Of-Use.pdf" target="_blank">
                  Terms Of Use
                </a>
              </div>
            </div>
              <div className="text-blue-500 text-sm">
                <a href="/files/Credore-Refund-Policy.pdf" target="_blank">
                  Refund Policy
                </a>
              </div>
          </Box>
